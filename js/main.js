(function($) {
    ...
    function resizeHeader() {
        const logoImage = document.getElementById("myImg");
    ...
    //                 if(windowWidth > 1200) {
    //                     if (logoImage) {
    //                         // logoImage.src = "images/UppedWhite.png";
    //                         logoImage.src = "images/Primary.png";
    //                     }
    //                     for(var i = 0; i< menuLinks.length; i++) {
    //                         menuLinks[i].style["color"] = "#fff"
    //                     }
    ...
    function setlogo() {
        ...
        if(windowWidth < 1200){
            // logoImage.src = 'images/Upped.png'
            logoImage.src = 'images/Primary.png'
